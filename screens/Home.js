...
const LineDivider = () => {
    return (
        <View style={{flex: 1,marginBottom: 10, justifyContent: 'center', alignItems: 'center'}}>
            <View style={{width: 500, height: 1, backgroundColor: COLORS.primary,}}></View>
        </View>
    )
} 
const [profile, setProfile] = React.useState(profileDate)
...
function renderHeader(profile)
    {
        return(
            <View style = {{ marginTop: 50, flex: 1, flexDirection:'row', paddingHorizontal: SIZES.padding, alignItems: 'center'}}>
                <View style = {{flex: 1}}>
    ...
    function renderMyBookSection(myBooks){
        const renderItem = ({item}) =>{
            ...
            <TouchableOpacity
            style = {{
                flex: 1, marginLeft: 0 == 0 ? SIZES.padding : 0,
            ...
            <View style = {{flex: 1}}>
                ...
                <View style = {{justifyContent: 'space-between',
                 paddingHorizontal: SIZES.padding, flexDirection : 'row'
                    ...
                    >
                        <Text style = {{
                            ...FONTS.body3, color: COLORS.lightBlue, 
