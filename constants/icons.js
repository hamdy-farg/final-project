...
export const profile_icon = require("../assets/icons/proifle_icon.png");
...
export const google_icon = require('../assets/icons/search.png');
export const apple_icon = require('../assets/icons/apple-logo.png');
